...
void check_math_operator_types() {
  test_valid_types<test_add_types, marray_test_size>();
  test_valid_types<test_sub_types, marray_test_size>();
  test_valid_types<test_mul_types, marray_test_size>();
  test_valid_types<test_div_types, marray_test_size>();

  test_valid_types<test_eq_types, marray_test_size>();
  // test_valid_types<test_inv_eq_types, marray_test_size>();
}
...
void check_math_function_types() {
  ...
  test_valid_types<test_abs_types, marray_test_size>();
  test_valid_types<test_acos_types, marray_test_size>();
  test_valid_types<test_asin_types, marray_test_size>();
  test_valid_types<test_atan_types, marray_test_size>();
  test_valid_types<test_acosh_types, marray_test_size>();
  test_valid_types<test_asinh_types, marray_test_size>();
  test_valid_types<test_atanh_types, marray_test_size>();
  test_valid_types<test_conj_types, marray_test_size>();
  test_valid_types<test_cos_types, marray_test_size>();
  test_valid_types<test_cosh_types, marray_test_size>();
  test_valid_types<test_exp_types, marray_test_size>();
  test_valid_types<test_log_types, marray_test_size>();
  test_valid_types<test_log10_types, marray_test_size>();
  test_valid_types<test_polar_types, marray_test_size>();
  test_valid_types<test_pow_types, marray_test_size>();
  test_valid_types<test_proj_types, marray_test_size>();
  test_valid_types<test_sin_types, marray_test_size>();
  test_valid_types<test_sinh_types, marray_test_size>();
  test_valid_types<test_sqrt_types, marray_test_size>();
  test_valid_types<test_tan_types, marray_test_size>();
  test_valid_types<test_tanh_types, marray_test_size>();
}
