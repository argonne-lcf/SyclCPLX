...
template <typename T, std::size_t NumElements> struct test_asin_marray {
...
int main() {
  ...
  // marray tests
  {
    ...
    test_passes &= test_valid_types<test_asin_marray, value_m_size>(Q, re, im);
    ...
    test_passes &= test_valid_types<test_asin_marray, error_m_size>(
